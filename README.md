  ...
  "channels": [
    {
      ...
      "google_sheet_url": "https://docs.google.com/spreadsheets/d/SHEET_ID/edit?gid=GID#gid=GID",
      "google_sheet_gid": "0",
      "content_style": "Phong cách nội dung",
      "target_audience": "Đối tượng khán giả",
...
**Lưu ý**: Hệ thống sẽ tự động đọc từ `channel_mapping_config.json` khi khởi động, không cần chạy script setup riêng.
